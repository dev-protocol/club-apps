...
<style scoped>
.hs-wallet.hs-wallet__details {
  --hs-wallet-details-fill: var(--hs-accent-400);
  --hs-wallet-details-ink: var(--hs-accent-ink);
  --hs-wallet-details-border: var(--hs-accent-400);
}

.hs-wallet.is-connected:hover {
  --hs-wallet-details-opacity: 1;
}
</style>
